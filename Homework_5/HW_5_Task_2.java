...
/**
 *
 * @param Cписок сотрудников.
 * @return Повторяющиеся слова с количеством повторений и сортировкой по убыванию.
 * @apiNote Дан список сотрудников. Написать программу, которая найдёт и выведет повторяющиеся имена с количеством повторений. Отсортировать по убыванию популярности.
 */

public class HW_5_Task_2 {
    public static void main(String[] args) {
        ...
        System.out.println("Повторение имён по убыванию:");
        for (int i = 0; i < sortedListValues.size(); i++) {
            System.out.println(sortedListKeys.get(i) + " - " + sortedListValues.get(i));
        }
    }
}